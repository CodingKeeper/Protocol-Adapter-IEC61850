...
public enum EventType {
    ...
    DIAG_EVENTS_GENERAL(1, "DIAG_EVENTS_GENERAL", EventNotificationTypeDto.DIAG_EVENTS, EventTypeDto.DIAG_EVENTS_GENERAL),
    LIGHT_EVENTS_LIGHT_ON(2, "LIGHT_EVENTS_LIGHT_ON", EventNotificationTypeDto.LIGHT_EVENTS, EventTypeDto.LIGHT_EVENTS_LIGHT_ON),
    LIGHT_EVENTS_LIGHT_OFF(3, "LIGHT_EVENTS_LIGHT_OFF", EventNotificationTypeDto.LIGHT_EVENTS, EventTypeDto.LIGHT_EVENTS_LIGHT_OFF),
    TARIFF_EVENTS_TARIFF_ON(4, "TARIFF_EVENTS_TARIFF_ON", EventNotificationTypeDto.TARIFF_EVENTS, EventTypeDto.TARIFF_EVENTS_TARIFF_ON),
    TARIFF_EVENTS_TARIFF_OFF(5, "TARIFF_EVENTS_TARIFF_OFF", EventNotificationTypeDto.TARIFF_EVENTS, EventTypeDto.TARIFF_EVENTS_TARIFF_OFF),
    MONITOR_EVENTS_LOSS_OF_POWER(6, "MONITOR_EVENTS_LOSS_OF_POWER", EventNotificationTypeDto.MONITOR_EVENTS, EventTypeDto.MONITOR_EVENTS_LOSS_OF_POWER),
    FUNCTION_FIRMWARE_EVENTS_ACTIVATING(7, "FUNCTION_FIRMWARE_EVENTS_ACTIVATING", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.FIRMWARE_EVENTS_ACTIVATING),
    FUNCTION_FIRMWARE_EVENTS_DOWNLOAD_NOTFOUND(8, "FUNCTION_FIRMWARE_EVENTS_DOWNLOAD_NOTFOUND", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.FIRMWARE_EVENTS_DOWNLOAD_NOTFOUND),
    FUNCTION_FIRMWARE_EVENTS_AUTHENTICATION_FAIL(9, "FUNCTION_FIRMWARE_EVENTS_AUTHENTICATION_FAIL", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.AUTHENTICATION_FAIL),
    FUNCTION_FIRMWARE_EVENTS_DOWNLOAD_FAILED(10, "FUNCTION_FIRMWARE_EVENTS_DOWNLOAD_FAILED", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.FIRMWARE_EVENTS_DOWNLOAD_FAILED),
    FUNCTION_FIRMWARE_EVENTS_DOWNLOAD_SUCCESS(11, "FUNCTION_FIRMWARE_EVENTS_DOWNLOAD_SUCCESS", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.FIRMWARE_EVENTS_DOWNLOAD_SUCCESS),
    SECURITY_FIRMWARE_EVENTS_ACTIVATING(12, "SECURITY_FIRMWARE_EVENTS_ACTIVATING", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.FIRMWARE_EVENTS_ACTIVATING),
    SECURITY_FIRMWARE_EVENTS_DOWNLOAD_NOTFOUND(13, "SECURITY_FIRMWARE_EVENTS_DOWNLOAD_NOTFOUND", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.FIRMWARE_EVENTS_DOWNLOAD_NOTFOUND),
    SECURITY_FIRMWARE_EVENTS_AUTHENTICATION_FAIL(14, "SECURITY_FIRMWARE_EVENTS_AUTHENTICATION_FAIL", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.AUTHENTICATION_FAIL),
    SECURITY_FIRMWARE_EVENTS_DOWNLOAD_FAILED(15, "SECURITY_FIRMWARE_EVENTS_DOWNLOAD_FAILED", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.FIRMWARE_EVENTS_DOWNLOAD_FAILED),
    SECURITY_FIRMWARE_EVENTS_DOWNLOAD_SUCCESS(16, "SECURITY_FIRMWARE_EVENTS_DOWNLOAD_SUCCESS", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.FIRMWARE_EVENTS_DOWNLOAD_SUCCESS),
    CA_FILE_EVENTS_ACTIVATING(17, "CA_FILE_EVENTS_ACTIVATING", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.CA_FILE_EVENTS_ACTIVATING),
    CA_FILE_EVENTS_DOWNLOAD_NOTFOUND(18, "CA_FILE_EVENTS_DOWNLOAD_NOTFOUND", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.CA_FILE_FIRMWARE_EVENTS_DOWNLOAD_NOT_FOUND),
    CA_FILE_EVENTS_AUTHENTICATION_FAIL(19, "CA_FILE_EVENTS_AUTHENTICATION_FAIL", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.AUTHENTICATION_FAIL),
    CA_FILE_EVENTS_DOWNLOAD_FAILED(20, "CA_FILE_EVENTS_DOWNLOAD_FAILED", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.CA_FILE_EVENTS_DOWNLOAD_FAILED),
    CA_FILE_EVENTS_DOWNLOAD_SUCCESS(21, "CA_FILE_EVENTS_DOWNLOAD_SUCCESS", EventNotificationTypeDto.FIRMWARE_EVENTS, EventTypeDto.CA_FILE_EVENTS_DOWNLOAD_SUCCESS),
    ...
    public String toString() {
        return String.format("EventType[evnType: %d, description: %s, notificationType: %s, osgpEventType: %s]",
